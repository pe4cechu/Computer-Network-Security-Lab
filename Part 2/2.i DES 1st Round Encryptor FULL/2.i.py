...
a = int(r0_e, 2) ^ int(k1, 2)

a_48 = f"{a:048b}"

s = [a_48[i : i + 6] for i in range(0, 48, 6)]
b = 0
...
p_b = "".join(f"{b:032b}"[p[i] - 1] for i in range(32))

r1 = int(p_b, 2) ^ int(l0, 2)

ciphertext = bin(r1 << 32 | int(r0, 2))[2:].zfill(64)
ciphertext = ciphertext[32:] + ciphertext[:32]

print(f"\033[95mCiphertext 1st Round: \033[97m{hex(int(ciphertext, 2))[2:].upper()}")